...
require('telekasten').setup({
    ...
    -- Keep case for tags or set them all to upper / lower
    -- options are preserve, upper, lower
    -- Currently doesn't work, search breaks, use preserve
    tag_preservecase = "preserve",
