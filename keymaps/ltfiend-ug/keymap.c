...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER2] = LAYOUT_5x6(
       _______,KC_F11 ,KC_F12 ,_______,DIGCF  , LOGCOM,                        UG_TOGG,UG_NEXT,UG_PREV,UG_VALU,_______,KC_DEL ,
    ...
    [_RGBLAY] = LAYOUT_5x6(
       _______,_______,_______,_______,_______,_______,                        UG_TOGG,UG_NEXT,UG_PREV,UG_VALU,UG_SPDU,_______,
       _______,_______,_______,_______,_______,_______,                        UG_SATU,_______,_______,_______,_______,_______,
       _______,_______,_______,_______,_______,_______,                        UG_HUEU,_______,_______,_______,_______,_______,
       _______,_______,_______,_______,_______,_______,                        _______,_______,_______,_______,_______,_______,
                                               _______,_______,            _______,_______,
                                               _______,_______,            _______,_______,
                                               _______,_______,            _______,_______,
